    ...
    <section id="about" className="py-24 px-6 lg:px-8 bg-gray-50 dark:bg-black">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900/50 rounded-2xl p-10 lg:p-14 border border-gray-200 dark:border-gray-800 shadow-sm">
              ...
              <div className="space-y-5 pt-2">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-gray-400 dark:bg-gray-500 mt-2.5 flex-shrink-0"></div>
          ...
          <motion.div {...fadeIn} className="pt-14 border-t border-gray-200 dark:border-gray-800">
            <p className="text-sm text-gray-600 dark:text-gray-400 text-center mb-12 uppercase tracking-wide font-medium">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-4xl font-semibold text-gray-900 dark:text-white mb-3">
                    {stat.value}
                  </div>
